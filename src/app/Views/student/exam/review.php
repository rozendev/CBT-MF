    ...
    <div class="col-lg-10">
        ...
        <div class="review-question-card">
            <div class="question-header" onclick="this.nextElementSibling.classList.toggle('open')">
                <div class="question-number <?= !empty($showScore) ? $status : 'neutral' ?>" style="<?= empty($showScore) ? 'background:#6c757d; color:#fff;' : '' ?>"><?= $no ?></div>
            ...
            <div class="question-body">
                ...
                <?php if ($log->question_type == 3): ?>
                    <!-- Essay -->
                    <div class="answer-option <?= $hasAnswer ? (!empty($showScore) ? ($log->score > 0 ? 'selected-correct' : 'selected-wrong') : 'neutral') : 'neutral' ?>">
                        <div class="answer-icon">
                            <?php if ($hasAnswer && !empty($showScore) && $log->score > 0): ?>
                                <i class="bi bi-check"></i>
                            <?php elseif ($hasAnswer && !empty($showScore)): ?>
                                <i class="bi bi-x"></i>
                            <?php else: ?>
                        ...
                        <div>
                            ...
                            <div class="answer-label <?= $hasAnswer ? (!empty($showScore) ? ($log->score > 0 ? 'text-success' : 'text-danger') : 'text-primary') : 'text-muted' ?>">
                                Jawaban Anda
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-sm">
                        <thead>
                            <tr>
                                ...
                                <?php if (!empty($showScore)): ?><th class="text-muted small text-center">Status</th><?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <?php else: ?>
                    ...
                    <?php foreach ($logAnswers as $ans):
                        ...
                        if ($isSelected && !empty($showScore)) {
                            ...
                            $optClass = 'neutral';
                            $optIcon = '<i class="bi bi-check-circle-fill text-primary"></i>';
                            $optLabel = 'Jawaban Anda';
                    ...
                    ?>
                        <div class="answer-option <?= $optClass ?>">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <?php if ($optLabel): ?>
                                    <div class="answer-label <?= !empty($showScore) ? (str_contains($optClass, 'correct') && !str_contains($optClass, 'wrong') ? 'text-success' : (str_contains($optClass, 'wrong') ? 'text-danger' : 'text-warning')) : 'text-primary' ?>">
                                        <?= $optLabel ?>
                                    </div>
                                <?php endif; ?>
                            </div>
