<h5 class="fw-bold mb-4">Langkah 5: Setup Akun Admin Utama</h5>
...
<form id="installForm">
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="?step=4" class="btn btn-outline-secondary" id="btnBack"><i class="bi bi-arrow-left"></i> Kembali</a>
