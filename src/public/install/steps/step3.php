<h5 class="fw-bold mb-4">Langkah 3: Integrasi Cloudflare</h5>
...
<form method="POST" action="index.php?step=4">
    ...
    <div class="d-flex justify-content-between mt-4">
        ...
        <button type="submit" class="btn btn-primary px-4">Lanjut Langkah 4 <i class="bi bi-arrow-right"></i></button>
    </div>
</form>
