<h5 class="fw-bold mb-4">Langkah 2: Konfigurasi Database & Redis</h5>
...
<form id="dbForm">
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="?step=1" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
        <div>
            <button type="button" id="btnTest" class="btn btn-info text-white me-2"><i class="bi bi-plug"></i> Test Koneksi</button>
            <button type="submit" id="btnNext" class="btn btn-primary px-4" disabled>Lanjut Langkah 3 <i class="bi bi-arrow-right"></i></button>
        </div>
    </div>
</form>
